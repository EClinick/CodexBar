...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let suppressedProviderReferences: [SuppressedProviderReference] = [
        ...
        SuppressedProviderReference(
            ...
            anchor: "for: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to an off-main publication guard."),
        SuppressedProviderReference(
            path: "Sources/CodexBar/UsageStore+CodexCostCatchUp.swift",
            line: 342,
        ...
        SuppressedProviderReference(
            ...
            anchor: "for: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This Codex account projection passes its fixed identity to an off-main publication guard."),
        SuppressedProviderReference(
            path: "Sources/CodexBar/UsageStore+SpendDashboardCodexCostCatchUp.swift",
            line: 304,
            anchor: "&& self.settings.isCostUsageEffectivelyEnabled(for: .codex)",
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenCost.swift",
            line: 198,
            anchor: "guard provider == .codex || provider == .claude else { return true }",
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 5,
            expectedReferenceFingerprint: ["claude@0", "codex@0", "claude@8", "codex@8", "codex@19"],
            reason: "CLIProxyAPI attribution guards apply only to providers that can contain proxy-routed usage."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenCost.swift",
            line: 354,
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/CostUsageFetcher.swift",
            line: 803,
            anchor: "provider == .claude || (provider == .codex && options.shouldMergeGlobalCodexUsage)",
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["claude@0", "codex@0", "codex@10", "codex@15"],
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/CostUsageFetcher.swift",
            line: 853,
